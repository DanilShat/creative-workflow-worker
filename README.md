...
If `claude_cli` or `codex_cli` shows unavailable, install the CLI and log in on this designer laptop. No `ANTHROPIC_API_KEY` or OpenAI API key is required for this worker path.
